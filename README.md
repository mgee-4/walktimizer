...
## Project Goals
- Learn about the physics of human walking
- Create a tool or device to enhance how we walk on the day to day
- Have fun!
...
- Differential pair impedance design for USB-C
- Layer stackup selection
- Manual design rule verification based on manufacturer capabilities

Fusion 360:
- Modelling components for Altium based on datasheets

CubeMX:
- Configuring pins for different peripherals
- Allocating pins based on availability and ease of routing

DaVinci Resolve:
- Keyframing volume, zoom, positions, opacity, etc.
